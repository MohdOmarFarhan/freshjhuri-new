...
const hexToRgba = (hex, opacity) => {
  if (!hex) return `rgba(245, 158, 11, ${opacity})`; // Default to honey-gold if missing
  let c;
            ...
            <div class="container mx-auto px-4 md:px-12">
              <div class="max-w-xl">
                ...
                <Link 
                  ...
                  class="inline-flex items-center justify-center gap-2 text-white px-8 py-4 rounded-xl font-semibold shadow-lg transition-all hover:gap-4 slide-btn"
                  :style="{
