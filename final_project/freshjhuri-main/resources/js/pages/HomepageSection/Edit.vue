...
const form = useForm({
    title_en: props.section.title_en,
    title_bn: props.section.title_bn,
    subtitle_en: props.section.subtitle_en || "",
    subtitle_bn: props.section.subtitle_bn || "",
    type: props.section.type,
    category_id: props.section.category_id,
    theme_color: props.section.theme_color,
...
const submit = () => {
    ...
    })).put(route("homepage-sections.update", props.section.id));
};
</script>

<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head title="Edit Homepage Section" />

        <div class="max-w-4xl mx-auto p-4 sm:p-2 lg:p-8">
            <Card>
                <CardHeader class="flex flex-row items-center justify-between">
                    <CardTitle class="text-xl font-bold">Edit Homepage Section</CardTitle>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex justify-end">
                            <Button type="submit" :disabled="form.processing">
                                <Save class="mr-2 h-4 w-4" /> Update Section
                            </Button>
                        </div>
                    </form>
                </CardContent>
