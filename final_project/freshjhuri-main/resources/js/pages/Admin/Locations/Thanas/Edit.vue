...
const form = useForm({
    district_id: props.thana.district_id,
    name: props.thana.name,
    bn_name: props.thana.bn_name,
});

const breadcrumbs = [
    { title: "Dashboard", href: route('dashboard') },
    { title: "Thanas", href: route('admin.thanas.index') },
    { title: "Edit", href: route('admin.thanas.edit', props.thana.id) },
];

const submit = () => {
    form.put(route('admin.thanas.update', props.thana.id));
};
</script>

<template>
    <Head title="Edit Thana" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="lg:w-full mx-auto p-4 sm:p-2 lg:p-8">
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="text-xl font-bold">Edit Thana: {{ thana.name }}</CardTitle>
                </CardHeader>
                <CardContent>
