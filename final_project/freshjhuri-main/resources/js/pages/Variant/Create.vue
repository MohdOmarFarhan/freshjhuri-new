...
const breadcrumbs = [
    ...
    { title: "Create", href: "/variants/create" },
];
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="lg:w-full mx-auto p-4 sm:p-2 lg:p-8">
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="text-xl font-bold">Create New Variant</CardTitle>
                </CardHeader>
                <CardContent>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <Input
                                    ...
                                    v-model="form.sku"
                                    type="text"
                                    placeholder="Enter unique SKU for this product"
                                    :class="{ 'border-red-500 focus-visible:ring-red-500': form.errors.sku }"
                                />
                                <span v-if="form.errors.sku" class="text-sm text-red-500">
                                    {{ form.errors.sku }}
                                </span>
                            </div>
                            ...
                            <div class="space-y-4 md:col-span-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <Button
                                        ...
                                        @click="addVariantRow"
                                    >
                                        <Plus class="mr-1 h-4 w-4" /> Add size
                                    </Button>
                                </div>
                                ...
                                <div
                                    ...
                                    :key="index"
                                    class="border border-gray-200 dark:border-gray-700 rounded-md p-4 relative"
                                >
                                    <!-- Remove button for variant row -->
                                    <button
                                        v-if="form.variants.length > 1"
                                        type="button"
                                        @click="removeVariantRow(index)"
                                        class="absolute top-2 right-2 text-red-600 hover:text-red-700 hover:bg-red-100 dark:text-red-400 dark:hover:text-red-300 dark:hover:bg-red-900/30 rounded-md p-1 transition-colors"
