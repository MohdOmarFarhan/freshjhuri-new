...
const form = useForm({
    ...
    image: null,
    tag_en: props.bannar.tag_en || '',
    tag_bn: props.bannar.tag_bn || '',
    theme_color: props.bannar.theme_color || '#047857',
    btn_text_en: props.bannar.btn_text_en || '',
    btn_text_bn: props.bannar.btn_text_bn || '',
    btn_link: props.bannar.btn_link || '',
    sort_order: props.bannar.sort_order || 0,
    _method: 'PUT'
});
