...
const breadcrumbs = [
    ...
    { title: "Create", href: "/bannars/create" },
];
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="lg:w-full mx-auto p-4 sm:p-2 lg:p-8">
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="text-xl font-bold">Create New Bannar</CardTitle>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6" enctype="multipart/form-data">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Tag English -->
                            <div class="space-y-2">
                                <Label for="tag_en" class="text-sm font-medium">Tag (English)</Label>
                                <Input id="tag_en" v-model="form.tag_en" type="text" placeholder="e.g. 100% Pure & Organic" />
                            </div>

                            <!-- Tag Bangla -->
                            <div class="space-y-2">
                                <Label for="tag_bn" class="text-sm font-medium">Tag (Bangla)</Label>
                                <Input id="tag_bn" v-model="form.tag_bn" type="text" placeholder="e.g. ১০০% খাঁটি" />
                            </div>

                            <!-- Button Text English -->
                            <div class="space-y-2">
                                <Label for="btn_text_en" class="text-sm font-medium">Button Text (English)</Label>
                                <Input id="btn_text_en" v-model="form.btn_text_en" type="text" placeholder="e.g. Shop Now" />
                            </div>

                            <!-- Button Text Bangla -->
                            <div class="space-y-2">
                                <Label for="btn_text_bn" class="text-sm font-medium">Button Text (Bangla)</Label>
                                <Input id="btn_text_bn" v-model="form.btn_text_bn" type="text" placeholder="e.g. এখনই কিনুন" />
                            </div>

                            <!-- Button Link -->
                            <div class="space-y-2">
                                <Label for="btn_link" class="text-sm font-medium">Button Link</Label>
                                <Input id="btn_link" v-model="form.btn_link" type="text" placeholder="e.g. /category/honey" />
                            </div>

                            <!-- Sort Order & Theme Color -->
                            <div class="space-y-2 flex gap-4">
                                ...
                                <div class="flex-1">
                                    <Label for="theme_color" class="text-sm font-medium block mb-2">Theme Color</Label>
                                    <input id="theme_color" v-model="form.theme_color" type="color" class="w-full h-10 border rounded px-1 py-1" />
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Max size: 2MB (JPG, PNG, GIF, WEBP)</p>
                        ...
                        <div class="flex justify-end space-x-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            >
                                ...
                                <span v-else>Create Bannar</span>
                            </Button>
                        </div>
                    </form>
                </CardContent>
