...
const breadcrumbs = [
  ...
  { title: "Create", href: "/service-videos/create" },
];
...
const submit = () => {
  ...
  form.post(route("service-videos.store"));
};
</script>

<template>
  <AppLayout :breadcrumbs="breadcrumbs">
    <Head title="Add Service Video" />

    <div class="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8">
      <Card>
        <CardHeader class="flex flex-row items-center justify-between pb-6">
          <CardTitle class="text-xl font-bold">Add Service Video</CardTitle>
