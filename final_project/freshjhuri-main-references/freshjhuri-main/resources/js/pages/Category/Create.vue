...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="lg:w-full mx-auto p-4 sm:p-2 lg:p-8">
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="text-xl font-bold">Create New Category</CardTitle>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6" enctype="multipart/form-data">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Image -->
                            <div class="space-y-2">
                                <Label for="image" class="text-sm font-medium">Category Image</Label>
                                ...
                                <div v-if="form.errors.image" class="text-sm text-red-500">{{ frontendErrorMessage(form.errors.image) }}</div>
