...
const breadcrumbs = [
    ...
    { title: "Create", href: "/footer/create" },
];
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="lg:w-full mx-auto p-4 sm:p-2 lg:p-8">
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Create Footer Item</CardTitle>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                             ...
                             <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    >
                                        ...
                                        <template v-else>
                                            <ImageIcon class="w-8 h-8 text-gray-400 mb-2" />
                                            <span class="text-xs text-gray-500">Upload Footer Image</span>
                                        </template>
                                    </div>
                                    <input 
                                        ref="imageInput"
                        ...
                        <div class="flex justify-end pt-4">
                            <Button type="submit" :disabled="form.processing">
                                {{ form.processing ? 'Creating...' : 'Create Footer Item' }}
                            </Button>
                        </div>
                    </form>
                </CardContent>
