...
const headers = [
    ...
    { text: "Thana", value: "thana.name", sortable: true },
...
<template>
    <Head title="Shipping Costs" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="lg:w-full mx-auto p-4 sm:p-2 lg:p-8">
            <Card>
                <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-4">
                    <CardTitle class="text-xl font-bold">Shipping Costs</CardTitle>
                    <Button as-child>
                        <Link :href="route('admin.shipping.create')">
                            <Plus class="mr-2 h-4 w-4" /> Add Shipping Cost
                        </Link>
                    </Button>
                </CardHeader>
                <CardContent>
                    ...
                    >
                        <template #item-action="item">
                            <div class="flex space-x-2 justify-end">
                                <Link
                                    :href="route('admin.shipping.edit', item.id)"
                                ...
                                <button
                                    @click="deleteShippingCost(item.id)"
