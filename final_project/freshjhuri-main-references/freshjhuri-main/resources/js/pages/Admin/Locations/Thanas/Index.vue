...
const headers = [
    ...
    { text: "Division", value: "district.division.name", sortable: true },
    { text: "District", value: "district.name", sortable: true },
...
const deleteThana = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(route('admin.thanas.destroy', id), {
                onSuccess: () => {
                    Swal.fire("Deleted!", "Thana has been deleted.", "success");
                }
            });
        }
    });
        ...
        <div class="lg:w-full mx-auto p-4 sm:p-2 lg:p-8">
            <Card>
                <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-4">
                    <CardTitle class="text-xl font-bold">Thanas</CardTitle>
                    <Button as-child>
                        <Link :href="route('admin.thanas.create')">
                            <Plus class="mr-2 h-4 w-4" /> Create Thana
                        </Link>
                    </Button>
                </CardHeader>
                <CardContent>
                    ...
                    >
                        <template #item-action="item">
                            <div class="flex space-x-2 justify-end">
                                <Link
                                    :href="route('admin.thanas.edit', item.id)"
