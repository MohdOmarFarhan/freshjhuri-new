...
const breadcrumbs = [
    ...
    { title: "Edit", href: route('admin.districts.edit', props.district.id) },
];

const submit = () => {
    form.put(route('admin.districts.update', props.district.id));
};
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="lg:w-full mx-auto p-4 sm:p-2 lg:p-8">
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="text-xl font-bold">Edit District</CardTitle>
                </CardHeader>
                <CardContent>
