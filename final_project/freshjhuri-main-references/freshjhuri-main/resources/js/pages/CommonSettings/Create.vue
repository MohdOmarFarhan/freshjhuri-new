...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/common-settings/create' },
];
...
const developerPreview = ref<string | null>(null);
...
const submit = () => {
    form.post(route('common.setting.store'), {
        forceFormData: true,
    });
};
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="p-6 space-y-6 max-w-5xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-foreground">Create Settings</h1>
                    <p class="text-muted-foreground">Configure the initial settings for your application.</p>
                </div>
